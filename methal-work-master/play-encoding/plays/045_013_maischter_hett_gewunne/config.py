...
datadir = "data"
outdir = "out"
oufn_prefix = "maischter_hett_gewunne"
...
summary_fpath = os.path.join(hocr_dir, "006.html")
#   in Clemens plays there's often a second spot with character and set info
has_long_set = False
second_set_info_fpath = os.path.join(hocr_dir, "006.html")
#   word index to add to 'second set'
start_second_set = -30

summary_title = "SZENE"
character_description_pnbr = 6
...
# body
has_acts = False
body_start_filename = 6 # not the page number but file number
body_end_filename = 60 # not the page number but file number
