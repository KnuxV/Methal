...
SINDIV=$PTHINDIV/work/plays/clemens-01-chrischtowe
SGRP=$PTHGRP/work/plays/clemens-chrischtowe
...
TEIBASIC=../out/chrischtowe.xml
CREATE_TEIFINAL=../out/chrischtowe_with_characters.xml
